(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'workpalmobile-opendoc-workpal'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-workpal/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "WorkPal Mobile"
